...
IMemberRepository memberRepository, IHubContext<PresenceHub> presenceHub) : Hub
{
    ...
    public async Task SendMessage(CreateMessageDto createMessageDto)
    {
        ...
        var recepient = await memberRepository.GetMemberByIdAsync(createMessageDto.RecipientId);

        if (recepient == null || sender == null || sender.Id == createMessageDto.RecipientId)
        ...
        var groupName = GetGroupName(sender.Id, recepient.Id);
        ...
        if (await messageRepository.SaveAllAsync())
        {
            ...
            var connections = await PresenceTracker.GetConnectionsForUser(recepient.Id);
